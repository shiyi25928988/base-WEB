...
public class UploadHelper {
	...
	/**
	 * ��������ͼ This method checks if the given file exists on disk. If it does
	 * it's ignored because that means that the file is allready cached on the
	 * server. If not we take out the stream from the digitalAsset-object and dumps
	 * a thumbnail to it.
	 */

	public void dumpAssetThumbnail(File file, String fileName, String thumbnailFile, String filePath, int width,
	...
	/**
	 * This method removes all images in the digitalAsset directory which belongs to
